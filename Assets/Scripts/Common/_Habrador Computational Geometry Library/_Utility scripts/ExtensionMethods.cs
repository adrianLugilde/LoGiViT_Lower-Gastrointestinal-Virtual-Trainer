...
namespace Habrador_Computational_Geometry
{
    public static class ExtensionMethods
    {
        ...
        //Vector3 - MyVector2 LUGILDE
        public static MyVector2 ToMyVector2_3DY(this Vector3 v)
        {
            return new MyVector2(v.x, v.z, v.y);
        }
        ...
        public static MyVector3 ToMyVector3_3DY(this MyVector2 v)
        {
            return new MyVector3(v.x, v._3DY, v.y);
        }
