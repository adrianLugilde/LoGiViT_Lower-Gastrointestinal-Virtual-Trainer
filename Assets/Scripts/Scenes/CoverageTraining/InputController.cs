...
namespace CoverageTraining
{
    public class InputController : MonoBehaviour, IXRViveDPadInteractor
    {
        ...
        public event Action OnToggleExploredOrganViewAction;
        ...
        private bool _inputActionsReady = false;

        public bool IsReady => _inputActionsReady && _vrSimpleSplineNavigator != null && _vrSimpleSplineNavigator.Ready;
        ...
        private void Awake()
        {
            ...
            /*VRSimpleSplineNavigator = GetComponentInChildren<VRSimpleSplineNavigator>();
            if (VRSimpleSplineNavigator == null)
    ...
    _onDpadLeftHoldPerf, _onDpadLeftHoldCanc, _onDpadRightPerf, _onDpadRightCanc, _onDpadTouched, _onLeftBButtonPerf,
    _onRightBButtonPerf, _onRightTrackpadHoldPerf, _onRightTrackpadHoldCanc, _onRightTrackpadDoubleTapPerf;
        ...
        private void SetInputSystemActions()
        {
            ...
            _onRightBButtonPerf += ctx => OnToggleExploredOrganViewPressed();
            ...
            //_leftHandGuidedInteractionActions.BButtonDoublePress.performed += ctx => OnToggleAIAssistance();
            //_rightHandGuidedInteractionActions.DpadDownPress.performed += ctx => OnToggleAIAssistance();
        ...
        {
            DpadPress();
            OnToggleExploredOrganViewPressed();
        }
        ...
        private void OnToggleExploredOrganViewPressed()
        {
            OnToggleExploredOrganViewAction?.Invoke();
        }
        ...
        public void SetInTrainingActionsEnable(bool enable)
        {
            ...
            SetExploredOrganViewActionActive(enable);
        ...
        public void SetExploredOrganViewActionActive(bool enable)
        {
            if (enable)
            {
