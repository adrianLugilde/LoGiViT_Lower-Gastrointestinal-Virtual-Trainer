...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
		...
		public float totalScaleAmount {get; protected set;}
		public Quaternion totalRotationAmount {get; protected set;}
		...
		public Vector3 pivotPoint {get; protected set;}
		...
		//TODO ACTUALIZAR AL NUEVO MODELO DE INPUT
		...
		public virtual IEnumerator TransformSelected(TransformType transType)
		{
			isTransforming = true;
			totalScaleAmount = 0;
		...
		protected float CalculateSnapAmount(float snapValue, float currentAmount, out float remainder)
		{
			remainder = 0;
		...
		protected Vector3 GetNearAxisDirection(out Vector3 otherAxis1, out Vector3 otherAxis2)
		{
		...
		protected void SetPivotPointOffset(Vector3 offset)
		{
			pivotPoint += offset;
