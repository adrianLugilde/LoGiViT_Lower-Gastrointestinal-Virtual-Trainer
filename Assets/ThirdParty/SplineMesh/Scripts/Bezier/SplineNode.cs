...
namespace SplineMesh {
    ...
    public class SplineNode {
        ...
        public SplineNode(Vector3 position, Vector3 direction, float roll, Vector3 up)
        {
            Position = position;
            Direction = direction;
            Roll = roll;
        ...
        public SplineNode(SplineNode sourceSplineNode)
        {
            ReplaceData(sourceSplineNode);
        }

        public void ReplaceData(SplineNode sourceSplineNode)
        {
            Position = sourceSplineNode.position;
            Direction = sourceSplineNode.direction;
            Roll = sourceSplineNode.roll;
