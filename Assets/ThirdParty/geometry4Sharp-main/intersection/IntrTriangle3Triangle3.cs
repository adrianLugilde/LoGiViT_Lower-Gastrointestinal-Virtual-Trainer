...
namespace g4
{
    ...
    public class IntrTriangle3Triangle3
    {
        ...
        public static bool Intersects(ref Triangle3d triangle0, ref Triangle3d triangle1, bool selfIntersections = false)
        {
            // Get edge vectors for triangle0.
            Vector3dTuple3 E0;
            E0.V0 = triangle0.V1 - triangle0.V0;
            ...
            //Check for shared edge if checking self intersections of mesh
            /*if(selfIntersections)
            {
                var tri1Verts = new List<Vector3d>() { triangle0.V0, triangle0.V1, triangle0.V2 };
                var tri2Verts = new List<Vector3d>() { triangle1.V0, triangle1.V1, triangle1.V2 };
                if (tri1Verts.Intersect(tri2Verts).Count() == 1) return false;
            }*/
